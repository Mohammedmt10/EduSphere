        ...
        <div>
            ...
            <div className="grid grid-cols-3 ml-10">
                {courses.map((course : course)=> (
                    ...
                    <CardElement title={course.courseId.title} price={course.courseId.price} imageUrl={course.courseId.imageUrl} description={course.courseId.description} buttonText="View Course" /></div>
                ))}
            </div>
        </div>
    </div>
